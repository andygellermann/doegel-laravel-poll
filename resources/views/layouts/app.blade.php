...
<body class="dragging">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="/umfragen">Umfragen</a>
    ...
    <script>var scenarios=["availableScreenResolution","canvas","colorDepth","cookies","cpuClass","deviceDpi","doNotTrack","indexedDb","installedFonts","language","localIp","localStorage","pixelRatio","platform","plugins","processorCores","publicIp","screenResolution","sessionStorage","timezoneOffset","touchSupport","userAgent","webGl"];imprint.test(scenarios).then(function(e){$("meta[name=fipr-token]").attr("content",e),$("input[name=fipr_token]").val(e),console.log(e)});</script>
</body>
</html>
