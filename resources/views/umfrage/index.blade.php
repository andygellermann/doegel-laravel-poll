...
@section('content')
    <div class="m-4">
        ...
        <p>Diese Seite wurde komplett mit Laravel sowie mit dem unaufregendem Design-Framework Bootstrap entwickelt und benötigt für den öffentlichen Bereich keine Cookies (wenngleich die Laravel-App diese auf Nutzerseite speichert). Stattdessen wird zur Eindämmung von mehrfach-Abstimmungen die "sogenannte" Fingerprint-Technologie verwendet. Sicherlich ist diese Technik mehr ein Schlupfloch als gesetzlich akzeptierte Technologie. Aber schauen Sie selbst.</p>
